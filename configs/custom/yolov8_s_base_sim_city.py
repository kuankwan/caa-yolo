...
# -----data related-----
data_root = '/home/gsx/.conda/envs/kuan11/DetLAB-master/data/sim10k/'  # Root path of data
target_root = '/home/gsx/.conda/envs/kuan11/DetLAB-master/data/cityscapes/'
# Path of train annotation file
train_ann_file = 'annotations/train_sim10k_caronly.json'
train_data_prefix = 'images/train/'  # Prefix of train image path
target_ann_file = 'annotations/train_modified_caronly.json'
target_data_prefix = 'images/train/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/val_modified_caronly.json'
...
# -----data related-----
img_scale = (608, 1120)  # width, height
test_scale = (608,1120)
...
test_pipeline = [
    dict(type='LoadImageFromFile', file_client_args=_base_.file_client_args),
    dict(type='YOLOv5KeepRatioResize', scale=test_scale),
    dict(
        type='LetterResize',
        scale=test_scale,
